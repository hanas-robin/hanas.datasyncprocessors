...
namespace hanas.datasynccontroller
{
    static class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //c_colib.cWriteLogs("Program", "Get Parameters (" + c_sMethod + ")!!");
            //c_colib.cWriteLogs("Program", "c_covar.host_type: " + c_covar.host_type + "(" + c_sMethod + ")!!");
            //c_colib.cWriteLogs("Program", "c_covar.host_localname: " + c_covar.host_localname + "(" + c_sMethod + ")!!");
            //c_colib.cWriteLogs("Program", "c_covar.host_localcode: " + c_covar.host_localcode + "(" + c_sMethod + ")!!");
            //c_colib.cWriteLogs("Program", "c_covar.host_remotename: " + c_covar.host_remotename + "(" + c_sMethod + ")!!");
            //c_colib.cWriteLogs("Program", "c_covar.host_remotecode: " + c_covar.host_remotecode + "(" + c_sMethod + ")!!");
            //Thread.Sleep(1000);

            ServiceBase[] ServicesToRun;
            ServicesToRun = new ServiceBase[]
            {
                new task_datasynccontroller()
            };
